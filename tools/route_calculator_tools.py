...
def get_user_information(ctx: RunContext[MyDeps], user_info: str) -> str | None:
    ...
    match user_info:
        case "amenity":
            return str(ctx.deps.user.get_pois_preferences().get_amenity())
        case "tourism":
            return str(ctx.deps.user.get_pois_preferences().get_tourism())
        case "historic":
            return str(ctx.deps.user.get_pois_preferences().get_historic())
        case "building":
            return str(ctx.deps.user.get_pois_preferences().get_building())
        case "natural":
            return str(ctx.deps.user.get_pois_preferences().get_natural())
        case "water":
            return str(ctx.deps.user.get_pois_preferences().get_water())
        case "leisure":
            return str(ctx.deps.user.get_pois_preferences().get_leisure())
        case "man_made":
            return str(ctx.deps.user.get_pois_preferences().get_man_made())
...
def find_the_recommendations(ctx: RunContext[MyDeps]) -> str | None:
    ...
    amenities = ctx.deps.user.get_pois_preferences().get_amenity()
