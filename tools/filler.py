...
def fill_trip_description(ctx: RunContext[MyDeps], gathered_informations: dict) -> None:
...
def fill_user_description(ctx: RunContext[MyDeps], gathered_informations: dict) -> None:
